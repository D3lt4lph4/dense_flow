...
static void convertFlowToImage(const Mat &flow_x, const Mat &flow_y, Mat &img_x,
                               Mat &img_y, double lowerBound,
                               double higherBound) {
#define CAST(v, L, H)                                                          \
...
int main(int argc, char **argv) {
  ...
  int frame_num = 0, intHeight = 0, intWidth = 0;
  ...
  while (true) {
    ...
    // Maybe set to a different resize size ?
